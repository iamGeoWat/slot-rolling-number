export default function rollingNumberCreator() {
  return function (t) {
    function e(a) {
      ...
      z.forEach(function (t, e) {
        var r = t.from * (S * g), a = (d * f + t.value) * (S * g), n = (0, c["default"])({
          from: r, to: a, delay: (z.length - 1 - e) * w + j, step: function (e) {
            ...
            var l = (a - r) / 2, i = Math.abs(Math.abs(e - r - l) - l) / 200;
            (n = t.filter, o.attr).call(n, "stdDeviation", "0 " + 0) //originally: "0 " + i
          }, end: 0 === e ? function () {
            return N()
          } : function (t) {
            return t
    ...
    e["default"] = function (t) {
      // original: n = t.duration
      var e = t.from, a = t.to, n = 2000, l = void 0 === n ? 3e3 : n, o = t.delay, i = void 0 === o ? 0 : o,
